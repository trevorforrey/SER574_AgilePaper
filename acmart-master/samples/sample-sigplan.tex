...
'The Agile way' (comment: Scrun is a way of doing Agile) of working has taken over as many organization's number one way to build products.
Although Agile practices have seen a great success, it can still be difficult to get multiple cross-functional agile (comment: adding more "buzzwords") teams to work together.
Thankfully, there are many strategies to successfully navigate through this network of interlinked agile teams.
Communication, negotiation, challenging assumptions, having a willingness to change, to learn from others, team structuring, tooling, and having clear designs are all important for the success of many agile teams.
\end{abstract}
...
The feedback cycle that a agile process creates also allow customer to be involved in the development of the product, which in turn helps deliverables.
...
The actual layout of an office / team working space can have an effect on the production of a software project.
In traditional businesses, teams can be split up in a way that creates silos. 
These silos block team members from collaborating with each other to fix a problem.
...
There's a real risk in a multi-team project to have certain members siloed off from each other.
By having a good communication channel, even physical siloes between developers can be overcome.
It's important to form these bridges of communication across teams, whether it be two product owners communicating regularly, or all team members.
...
These events can come in the form of: cross-team stand-ups, multiple project owners communicating, cross-team planning [2].
...
Jenkins also allows for integration tests to be automatically performed, letting developers know if there recent additions have broken a part of the project.
